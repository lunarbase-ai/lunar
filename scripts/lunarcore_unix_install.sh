...
EXAMPLE_PERSISTENT_REGISTRY_STARTUP_FILE="${LUNARCORE_ROOT}/lunarbase/[EXAMPLE]components.txt"
DEFAULT_PERSISTENT_REGISTRY_STARTUP_FILE="${LUNARCORE_ROOT}/lunarbase/components.json"
