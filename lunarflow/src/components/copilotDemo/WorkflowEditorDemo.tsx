...
import EditorGenerateInputDemo from './editorGenerateInputDemo';
...
const WorkflowEditorDemo: React.FC<WorkflowEditorProps> = ({
  workflowId,
  workflow,
  components,
}) => {
          ...
          <ReactFlowProvider>
            ...
            <Sider collapsed={collapsed} collapsedWidth={0} collapsible width={280} style={{ background: '#fff' }}>
              <div style={{ display: 'flex', height: '100%', width: '100%', flexDirection: 'column' }}>
                <EditorGenerateInputDemo workflowId={workflowId} />
              </div>
            </Sider>
          </ReactFlowProvider>
        </WorkflowRunningProvider>
...
export default WorkflowEditorDemo
