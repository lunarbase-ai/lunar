...
import WorkflowListActions from "../workflowList/WorkflowListActions"
...
const WorkflowListDemo: React.FC<WorkflowListProps> = ({ workflows }) => {
      ...
      renderItem={(item) => (
        <>
          <List.Item key={item.id}>
            <List.Item.Meta
              title={<Link onClick={() => router.push(`/demo/editor/${item.id}`)}>{item.name}</Link>}
...
export default WorkflowListDemo
