...
function createAzure(options = {}) {
  ...
  const url = ({ path, modelId }) => options.baseURL ? `${options.baseURL}/openai/deployments/${modelId}${path}?api-version=2024-02-01` : `https://${getResourceName()}.openai.azure.com/openai/deployments/${modelId}${path}?api-version=2024-10-01-preview`;
